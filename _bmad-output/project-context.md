...
**Database (CRITICAL):**
- Supabase PostgreSQL - THIS IS THE DATABASE
- UUID = Primary Key (auto-generated by Supabase)
- Version column for optimistic locking (race condition protection)
- 6 tables: leads, deduplication_log, sales_team, status_history, campaign_events, campaign_stats
...
- Reset in `beforeEach`: `Object.values(mockChain).forEach(fn => fn.mockReturnThis())`
...
- Current: 1423+ backend tests passing
...
*Last Updated: 2026-02-10 (Epic 9: Supabase Migration — Google Sheets removed)*
